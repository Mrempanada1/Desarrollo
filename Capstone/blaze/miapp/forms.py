...
class CotizacionForm(forms.ModelForm):
    class Meta:
        model = Cotizacion  # Asegúrate de que este modelo esté definido en models.py
        fields = ['vehiculo', 'servicio', 'monto_estimado', 'estado']
        widgets = {
            'vehiculo': forms.Select(attrs={'class': 'form-control'}),
            'servicio': forms.Select(attrs={'class': 'form-control'}),
            'monto_estimado': forms.NumberInput(attrs={'class': 'form-control'}),
            'estado': forms.TextInput(attrs={'class': 'form-control'}),
        }
